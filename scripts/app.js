   ...
   var production_config = {
    ...
    function uploadFileToServer(file){
      console.log("Started upload...");
        ...
        $.ajax({
          url: "https://azania-cloud.firebase.com/file",
          type: "POST",
          data: formData,
          processData: false,
          contentType: false,
      ...
      function uploadFolderToServer(files, details){
        ...
        $.ajax({
          url: "https://azania-cloud.firebase.com",
          type: "POST",
    ...
    function deleteDoc(){
      ...
      $.ajax({
          url: "https://azania-cloud.firebase.com/delete",
          type: "POST",
          enctype: 'multipart/form-data',
          data: formData,
          processData: false,
    ...
    function shareViaEmail(){
      ...
      var email={
       ...
       $.ajax({
        url: "https://azania-cloud.firebase.com/email",
        type: "POST",
        data: email,
    ...
    function downloadLink(){
      if(document.getElementById("card_select_"+highlighted_keys[0]).classList.value.includes("folder")){
        //if the element is a folder
         window.open("https://azania-cloud.firebase.com/folder/"+highlighted_keys[0]);
      }
      else{
        //if the element is a file
